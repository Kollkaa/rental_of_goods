          ...
          GestureDetector(
            child:Container(
              ...
              child:Row(
                ...
                children: [
                  Text(widget.text,style: TextStyle(fontWeight: open?FontWeight.bold:FontWeight.normal,fontSize: 16),),
                  Icon(open?Icons.keyboard_arrow_down:Icons.keyboard_arrow_right,size: 15,)
                ],
              ),
            ),
            onTap: (){
