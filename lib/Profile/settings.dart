      ...
      appBar: AppBar(
        ...
        title: Row(
          ...
          children: [
            ...
            Text("/ Настройки",style: style_title2,),
            Opacity(
              opacity: 0,
        ...
        children: [
          Container(
            ...
            Column(
              ...
              children: [
                Text("Уведомления",style: style_title2,),
                Container(
                  height: screenHeight,
                  color: color_text_white,
                  padding: EdgeInsets.all(20),
                  ...
                  Column(
                    ...
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text("О новых товарах",style: style_title1,),
                      SizedBox(height: screenHeight*0.02,),
                      Row(
                        children: [
                          Text("ПУШ",style: style_title1,),
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          border: Border(bottom: BorderSide(width: 0.2,color: color_text_grey))
                        ),
                      ),
                      SizedBox(height: screenHeight*0.02,),
                      Text("О сообщениях",style: style_title1,),
                      SizedBox(height: screenHeight*0.02,),
                      Row(
                        children: [
                          Text("ПУШ",style: style_title1,),
